<template>
  <div class="project-banner">
    ...
    <div
      class="col-image"
      :class="{
        'col-image-shrink': props.type === constants.ProjectBannerType.STANDARD,
      }"
    >
      <ImageView
    ...
    <!-- Texts - Featured -->
    <div
      v-if="props.type === constants.ProjectBannerType.FEATURED"
      class="col-texts col-texts-featured"
    >
      <h4 class="title mb-2 text-light-5">
        <i class="fa-solid fa-fire me-2" /> Latest Release
      </h4>
      <h1
      ...
      <SocialLinks
        ...
        :color="constants.SocialLinksColor.BLACK"
        :size="constants.SocialLinksSize.XL"
        class="mt-xl-5"
      />
    </div>
